...
<!-- NO EDITAR — generado por scripts/build-plugins.mjs desde src/skills/cargar-propiedad/SKILL.md. Los cambios hechos aquí se pierden en el próximo build; edita la fuente. -->
...
2. **Guías**: `entrevista-propiedad.md` es la que manda aquí (recorrido, deducción→confirmación,
   ...
   Todas viven en `references/` de esta misma skill, en cualquiera de los dos formatos.
