<!-- NO EDITAR — generado por scripts/build-plugins.mjs desde src/skills/cargar-propiedad/references/flujo-mcp.md. Los cambios hechos aquí se pierden en el próximo build; edita la fuente. -->
