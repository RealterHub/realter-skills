<!-- NO EDITAR — generado por scripts/build-plugins.mjs desde src/skills/crear-guion-video/references/tipos-de-video.md. Los cambios hechos aquí se pierden en el próximo build; edita la fuente. -->
