...
<!-- NO EDITAR — generado por scripts/build-plugins.mjs desde src/skills/escribir-articulo/SKILL.md. Los cambios hechos aquí se pierden en el próximo build; edita la fuente. -->
...
1. `get_brand_foundations` SIEMPRE antes de redactar. Workspace: `articulos/<slug>/pieza.json`
   (+ `pieza.md`), convención de `references/workspace.md`; modo degradado sin filesystem.
