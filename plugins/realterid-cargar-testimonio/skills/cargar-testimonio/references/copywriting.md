<!-- NO EDITAR — generado por scripts/build-plugins.mjs desde src/guides/copywriting.md. Los cambios hechos aquí se pierden en el próximo build; edita la fuente. -->
