...
<!-- NO EDITAR — generado por scripts/build-plugins.mjs desde src/skills/fundamentos-de-marca/SKILL.md. Los cambios hechos aquí se pierden en el próximo build; edita la fuente. -->
...
1. **Lee las guías**: `storytelling.md`, `copywriting.md` y **`entrevista-biografica.md`** — en
   `references/` de esta misma skill (el build las copia ahí en los dos formatos).
...
2. **Workspace**: aplica `references/workspace.md`. Esta pieza vive en
