<!-- NO EDITAR — generado por scripts/build-plugins.mjs desde src/skills/fundamentos-de-marca/references/compilacion.md. Los cambios hechos aquí se pierden en el próximo build; edita la fuente. -->
