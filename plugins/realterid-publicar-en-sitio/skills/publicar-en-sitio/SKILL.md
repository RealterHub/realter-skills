...
<!-- NO EDITAR — generado por scripts/build-plugins.mjs desde src/skills/publicar-en-sitio/SKILL.md. Los cambios hechos aquí se pierden en el próximo build; edita la fuente. -->
...
El paso final del workspace (`references/workspace.md`): mirar todas las piezas locales, decidir
...
- [x] Algoritmo de hash normalizado (JSON canónico): documentado en `references/workspace.md`
